...
const { fotos } = datos; // desustructuracion

var dataCategorias = { // simulamos un servidor con informacion de las categorias 
  categorias: [
...
const contenedorCategorias$1 = document.getElementById('categorias'); // accedemos al arreglo de categorias
...
categorias.forEach((categoria) => {
  ...
  contenedorCategorias$1.append(nuevaCategoria); // agregamos la nueva categoria que creamos
});
...
const cargarImagen = (id, nombre, ruta, descripcion) => {
  ...
  const categoriaAtual = galeria$4.dataset.categoria;
  const fotos = datos.fotos[categoriaAtual];
